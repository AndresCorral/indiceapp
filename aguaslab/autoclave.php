...
<div class="booking" id="booking" style="background-image: url(images/fondos/autoclave.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12"> <h2 class="section-title" >
					<span class="bold700" >Análisis Autoclave
 </h2>
				<p > 
¿Utilizas elementos que requieren esterilización? <br><br>
Asegúrate de estar realizando el proceso adecuadamente y elimina todas las bacterias que
puedan existir. <br> <br>
Te enviamos la ampolla sin costo alguno, ¡Hagamos un análisis!
