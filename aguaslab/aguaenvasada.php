...
<div class="booking" id="booking" style="background-image: url(images/fondos/aguaenvasada.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12" > <h2 class="section-title" >
					<span class="bold700" >Análisis de agua envasada
 </h2>
				<p>La calidad de tu producto depende directamente del proceso que manejas para envasarlo. <br><br>
Desde bacterias hasta químicos en exceso pueden afectar la vida util de tu producto y generar rechazo por parte de tu cliente, cumple les a
ellos y al INVIMA. <br><br> ¡solicita tus análisis ya!
