...
<div class="booking" id="booking" style="background-image: url(images/fondos/zona.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12" > <h2 class="section-title" >
					<span class="bold700" >Análisis de Zonas Húmedas
 </h2>
				<p >Las duchas, las playas de las piscinas y todo lugar que permanezca húmedo es un reservorio de hongos, levaduras dermatofitos . <br><br>
¡Es conveniente hacer un análisis periódico para saber que todo está libre de enfermedades!
