...
<div class="booking" id="booking" style="background-image: url(images/fondos/asesoria.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12" > <h2 class="section-title" >
					<span class="bold700" >Asesorías

 </h2>
				<p > 
Muchas veces llegas a un punto en el que te preguntas ¿Ahora que debo hacer? <br><br>
Con más de 15 años de experiencia, contamos con los profesionales que pueden
aclarar todas las dudas que tengas. <br><br>
¡Contáctanos ahora, queremos ayudarte!
