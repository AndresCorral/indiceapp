...
<div class="booking" id="booking" style="background-image: url(images/fondos/piscina.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12"> <h2 class="section-title" >
					<span class="bold700" >Análisis de piscina </h2>
				<p>¿sabias que un mal tratamiento del agua puede causar multiples enfermedades a los niños y adultos mayores inmunodeficientes?</p>
				
				<p>El exceso de quimicos puede hacer un agua toxica<br> </p> </div>
