...
<div class="booking" id="booking" style="background-image: url(images/fondos/aguacruda.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12"> <h2 class="section-title" >
					<span class="bold700" >Análisis de agua Cruda
 </h2>
				<p>Estas sacando agua de un aljibe o de un rio para consumirla o para usarla en el hogar? <br><br>
Estas aguas siempre vienen con una carga de elementos que son dañinos para la salud y que, a
largo plazo pueden enfermar gravemente a quienes la usen. <br><br>
¡Analicemos esa agua para volverla potable!
