...
<div class="booking" id="booking" style="background-image: url(images/fondos/filtro.jpg);">
	<div class="container">
		<div class="row" >
			<div class="texto col-lg-6 col-md-6 col-sm-6 col-xs-12" > <h2 class="section-title" >
					<span class="bold700" >Filtro purificador
 </h2>
				<p > 
La función de un filtro purificador es garantizar que bebes un agua limpia y sana. <br><br>¿Estás seguro que tu filtro esta haciendo el trabajo? <br><br>Un análisis te lo dirá
